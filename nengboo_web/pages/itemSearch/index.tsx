...
const ItemSearch = () => {
  ...
  return (
    <main className="relative mx-auto h-[100dvh] w-full max-w-[430px] overflow-y-hidden bg-[#ffffff]">
      <section className="container mx-auto px-4 py-8 flex flex-col min-h-screen overflow-y-auto overflow-y-hidden; ">
        <SearchBar
          value={searchTerm}
        ...
        {filteredData.length > 0 ? (
          <ul className="grid grid-cols-1 gap-4 mt-8 ">
            {filteredData.map((product) => (
              ...
              >
                <figure className="relative items-center w-20 h-20 mr-4">
                  <Image
                ...
                <figcaption className="flex flex-row justify-between w-full">
                  <div className="flex flex-col justify-between">
                    <p className="text-ml font-semibold mb-2">
                      {product.product_name}
                    </p>
                    {product.product_expiration_date && (
                      <p className="text-gray-500">
                        {product.product_expiration_date} 까지
                      </p>
                    )}
          ...
          <article className="mt-8 flex flex-col text-center text-black">
